    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#EDEDED] dark:bg-[#0A0D14] font-sans antialiased transition-colors duration-500 overflow-hidden">
      ...
      <div className="w-full md:w-[45%] lg:w-[40%] p-8 md:p-12 lg:p-16 xl:p-20 flex flex-col justify-between h-auto min-h-screen z-10 box-border relative">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4 items-center">
          <button className="w-full sm:w-auto px-8 py-3.5 bg-[#25394B] hover:bg-[#1A2A3A] dark:bg-white dark:hover:bg-gray-200 text-white dark:text-[#25394B] text-sm md:text-base font-semibold rounded-lg transition-all duration-300 shadow-xl flex items-center justify-center gap-3">
            Sign up <ArrowRight size={18} />
          </button>
          <button className="w-full sm:w-auto px-8 py-3.5 bg-transparent hover:bg-black/5 dark:hover:bg-white/10 text-[#25394B] dark:text-white text-sm md:text-base font-semibold rounded-lg transition-all duration-300 flex items-center justify-center">
            Login
          </button>
        </div>
      </div>
