  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-[#0A0D14]' : 'bg-[#F8FAFC]'} font-sans text-slate-700 dark:text-slate-200 relative animate-page-enter transition-colors duration-300`}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className={`absolute top-0 left-0 right-0 h-[800px] ${isDarkMode ? 'bg-linear-to-br from-[#6B5AED]/30 via-[#6B5AED]/5 to-transparent' : 'bg-linear-to-br from-[#6B5AED]/10 via-[#6B5AED]/5 to-transparent'} blur-[130px]`}></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            >
              ...
              />
              <span className="text-sm font-medium text-slate-700 dark:text-slate-200 hidden sm:block">{user?.fullName || "Sarah Connor"}</span>
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-3 w-52 bg-white dark:bg-[#1A1F2E] border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-2xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                <button 
                  ...
                  className="w-full flex cursor-pointer items-center gap-3 px-4 py-3 text-sm text-slate-600 dark:text-slate-300 hover:text-[#6B5AED] dark:hover:text-white hover:bg-slate-50 dark:hover:bg-[#252b40] transition-colors mt-1"
                >
                  <Settings size={18} />
                  Settings
                </button>
                ...
                className="w-full flex cursor-pointer items-center gap-3 px-4 py-3 text-sm text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-400/10 transition-colors mb-1">
                  <LogOut size={18} />
                  Logout
                </button>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-10 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Your Groups</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {groups?.map((group, index) => {
              ...
              <div 
                ...
                className="bg-white dark:bg-[#1A1F2E]/60 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-6 hover:border-[#6B5AED]/50 hover:bg-slate-50 dark:hover:bg-[#1A1F2E]/90 hover:-translate-y-1 transition-all duration-300 flex flex-col group cursor-pointer shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-lg hover:shadow-xl animate-slide-up opacity-0">
                {/* Card Top */}
                ...
                <div className="flex justify-between items-start mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-slate-900 dark:text-white group-hover:text-[#6B5AED] transition-colors">{group.name}</h3>
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Updated recently</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-slate-50 dark:bg-[#0A0D14]/50 rounded-xl p-4 border border-slate-100 dark:border-slate-800/50">
                    ...
                    <p className={`font-semibold text-lg ${
                      group.myBalance < 0 ? 'text-rose-500' : 
                      balanceRounded > 0 ? 'text-emerald-500' : 
                      'text-slate-500'
                    }`}>
